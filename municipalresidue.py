...
#Since we municipal residue is being used as input
df = df[['Year','Month', 'Day', 'biogas_production', 'Municipal Residue (kg)','Water (L)','Diesel (L)','Electricity Use (kWh)','Temperature (C)','Humidity (%)',
...
x_train = x_train[['biogas_production', 'Municipal Residue (kg)','Water (L)','Diesel (L)','Electricity Use (kWh)','Temperature (C)','Humidity (%)',
         'Rainfall (mm)','C/N Ratio','Digester Temp (C)']]
x_test = x_test[['biogas_production', 'Municipal Residue (kg)','Water (L)','Diesel (L)','Electricity Use (kWh)','Temperature (C)','Humidity (%)',
         'Rainfall (mm)','C/N Ratio','Digester Temp (C)']]
...
plt.title('Biogas Yield Forecast (Municipal Residue Feedstock)')
plt.xlabel('Date')
