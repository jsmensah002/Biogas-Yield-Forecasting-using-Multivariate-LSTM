...
#Since we bagasse is being used as input
df = df[['Year','Month', 'Day', 'biogas_production', 'Bagasse Feed (kg)','Water (L)','Diesel (L)','Electricity Use (kWh)','Temperature (C)','Humidity (%)',
...
x_train = x_train[['biogas_production', 'Bagasse Feed (kg)','Water (L)','Diesel (L)','Electricity Use (kWh)','Temperature (C)','Humidity (%)',
         'Rainfall (mm)','C/N Ratio','Digester Temp (C)']]
x_test = x_test[['biogas_production', 'Bagasse Feed (kg)','Water (L)','Diesel (L)','Electricity Use (kWh)','Temperature (C)','Humidity (%)',
         'Rainfall (mm)','C/N Ratio','Digester Temp (C)']]
...
plt.title('Biogas Yield Forecast (Bagasse Feed Feedstock)')
plt.xlabel('Date')
